...
const semanticShadowTokens = {
  ...
  buttonFocus: `inset 0 0 0 1px ${vars.greyOpacity800}, inset 0 0 0 2px rgba(255, 255, 255, 0.5), 0 0 4px 4px ${vars.greyOpacity200}`,
  select: `0 0 0 1px ${shadows.shadowMedium00}, 0 10px 30px 0 ${shadows.shadowMedium01}, 0 20px 40px 0 ${shadows.shadowMedium02}`,
  switchThumb: `0 0 0 1px ${vars.greyOpacity100}, 0 2px 4px 0 rgba(0, 0, 0, 0.18)`,
  tooltip: `0 0 0 1px ${shadows.shadowMedium00}, 0 10px 30px 0 ${shadows.shadowMedium01}, 0 20px 40px 0 ${shadows.shadowMedium02}`,
  selectOutline: `inset 0 0 0 1px ${vars.grey200}`,
  selectOutlineHover: `inset 0 0 0 1px ${vars.violetOpacity200}`,
  segmentedControlIndicator: `${vars.greyOpacity200} 0px 1px 3px 0px`,
} as const;
