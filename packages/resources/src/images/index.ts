...
export const loginGuideDark = new URL('./login-guide-dark.png', import.meta.url).href;
export const loginGuideLight = new URL('./login-guide-light.png', import.meta.url).href;
