...
import type {
  ...
  ApplicantDocumentEvaluationsResponseType,
  ApplicantType,
...
// 아직 서류 평가를 제출하지 않은 상태(UNDER_REVIEW)를 그대로 반영해요.
const mockEvaluations: ApplicantDocumentEvaluationsResponseType = {
  totalScore: 0,
  items: [],
  overallComment: '',
  result: 'PENDING',
...
export const handlers = [
  ...
  http.get(`${config.apiBaseURL}/applicants/:applicantId/documents/evaluations`, () => {
